...
var ToppingService = (function () {
    function ToppingService(http) {
        this.http = http;
        this.toppingsUrl = 'http://127.0.0.1:8800/toppings/';
    }
    ...
    ToppingService.prototype.extractData = function (res) {
        var body = res.json();
        console.log(body);
        return body || {};
    };
    ToppingService.prototype.handleError = function (error) {
